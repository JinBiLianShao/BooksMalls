...
<div id="right" >
  ...
  <form name="form1" method="post" action="/ttt11/index.php/Admin/Dingdan/DingdanDelAll">
   ...
   <tr>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dingdan): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td height="21" bgcolor="#FFFFFF"><div><?php echo ($dingdan["zt"]); ?></div></td>
          ...
          <div>
            <a href="/ttt11/index.php/Admin/Dingdan/DingdanSaveShow/orderid/<?php echo ($dingdan["orderid"]); ?>">查看</a>&nbsp;&nbsp;
            <a href="/ttt11/index.php/Admin/Dingdan/DingdanDel/orderid/<?php echo ($dingdan["orderid"]); ?>">删除</a>
          </div>
        </td>
