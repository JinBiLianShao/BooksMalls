...
<div id="right" >
  ...
  <form action="/ttt11/index.php/Admin/Book/BookAdd" method="post" onsubmit="return sjyz(this)" enctype="multipart/form-data">
            ...
            <tr  bgcolor="#FFFFFF">
              ...
              <td>
                <select id="nian" name="nian" style="margin-left:10px;">
                	<?php $__FOR_START_14879__=1900;$__FOR_END_14879__=2019;for($i=$__FOR_START_14879__;$i < $__FOR_END_14879__;$i+=1){ ?><option><?php echo ($i); ?></option><?php } ?>
                </select>年
                <select id="yue" name="yue">
                	<?php $__FOR_START_24940__=1;$__FOR_END_24940__=13;for($i=$__FOR_START_24940__;$i < $__FOR_END_24940__;$i+=1){ ?><option><?php echo ($i); ?></option><?php } ?>
                </select>月
                <select id="ri" name="ri">
                	<?php $__FOR_START_4917__=1;$__FOR_END_4917__=32;for($i=$__FOR_START_4917__;$i < $__FOR_END_4917__;$i+=1){ ?><option><?php echo ($i); ?></option><?php } ?>
                </select>日
              </td>
            </tr>
            <tr  bgcolor="#FFFFFF">
