...
<div id="right" >
  ...
  <form name="form1" method="post" action="/ttt11/index.php/Admin/Gonggao/GonggaoDelAll">
      ...
      <table width="670" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gonggao): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td height="25" bgcolor="#FFFFFF">
              <a href="/ttt11/index.php/Admin/Gonggao/GonggaoSaveShow/id/<?php echo ($gonggao["id"]); ?>">查看</a>&nbsp;&nbsp;
              <a href="/ttt11/index.php/Admin/Gonggao/GonggaoDel/id/<?php echo ($gonggao["id"]); ?>">删除</a>
            </td>
