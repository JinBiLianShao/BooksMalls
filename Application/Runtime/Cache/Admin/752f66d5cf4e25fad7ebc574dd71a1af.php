...
<div id="right" >
  ...
  <form action="/ttt11/index.php/Admin/Type/TypeDelAll" method="post" >
        ...
        <td  bgcolor="#666666"><table width="670" cellspacing="1" border="0px">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td width="122"  bgcolor="#FFFFFF">
                <div>
                  <a href="/ttt11/index.php/Admin/Type/TypeSaveShow/typeid/<?php echo ($type["typeid"]); ?>">修改</a>&nbsp;
                  <a href="/ttt11/index.php/Admin/Type/TypeDel/typeid/<?php echo ($type["typeid"]); ?>">删除</a>
                  <!-- <a href="/ttt11/index.php/Admin/Type/TypeSaveShow/typeid/<?php echo ($type["typeid"]); ?>">修改</a>&nbsp;
                  <a href="/ttt11/index.php/Admin/Type/TypeDel/typeid/<?php echo ($type["typeid"]); ?>">删除</a> -->
                </div>
              </td>
