...
--
-- Host: 127.0.0.1
-- Generation Time: 2020-04-16 18:11:44
...
(8, 5, 2012004, '穆斯林的葬礼', '霍达', '人民文学出版社', '2010-1-1', '40', '7', 'upimages/shu14.jpg', '“图书”一词最早出现于《史记?萧相围世家》，刘邦攻入咸阳时，“何独先入收秦丞相御史律令图书藏之。沛公为汉王，以何为丞相。…汉王所以具知天下厄塞，户口多少，强弱之处，民所疾苦者，以何具得秦图书也”。这里的“图书”指的是地图和文书档案，它和我们今天所说的图书是有区别。进一步探求“图书”一词的渊源，可追溯到《周易?上系辞》记载的“河出图、洛出书”这个典故上来，它反映了图画和文字的密切关系。虽然是神话传说，但却说明了这样一个事实：文字起源于图画。图画和文字确实是紧密相连的。古人称各种文字形态为“书体”，写字的方法为“书法”“书“字还被作为动词，当“写”讲，如“罄竹难书”、“奋笔疾书”、“大书特书”等等。以后，“书”便进一步被引申为一切文字记录。如“书信”、“文书”“刑书”、“诏书”、“盟书”等等。随着历史的发展，人们对于图书的认识也在不断地发生变化。到了今天，人们已经不再把一创文字记录都称作“书”了。例如文书、书信、诏书、盟书，虽然都带有“书”字，但已不包括在图书的范围之内。古文记载，其内容多是记事性质的，如甲骨卜辞、青铜器铭文等，都是属于这一类的，其作用主要是为帮助记忆，以便需要时检查参考，其性质相当于后世的档案。以后人们从实践中认识到，这些记录的材料可以改变成总结经验、传授知识的工具。于是便出现了专为传授知识、供人阅读的著作。这样，图书一词便取得了较新而又较窄的意义。到后来，凡不以传播经验、传授知识、供人阅读为目的的文字记录就不算图书了；随着生产力的发展和社会的进步，人们开始有意识她运用文字来宣传思想，传播知识，同时也逐步地形成了一套书籍制度,而处理日常事务的文件又形成了一套文书制度。于是，图书与档案就逐渐被区分开了。 ', 0, 1),
...
(3, '2013182991@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '上海', '1825582847+', '2013182991@qq.com', '0000-00-00'),
(4, '123456', 'e10adc3949ba59abbe56e057f20f883e', '上海', '12345678900', '123456@qq.com', '0000-00-00'),
(5, '123123', 'e5e5b55b7387b4f41e854f5344802200', '', '12345678912', '124578963@qq.com', '0000-00-00');
...
--
-- AUTO_INCREMENT for table `tb_dingdan`
--
ALTER TABLE `tb_dingdan`
  MODIFY `orderid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
-- AUTO_INCREMENT for table `tb_gonggao`
--
ALTER TABLE `tb_gonggao`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT '公告id',AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `tb_gwc`
--
ALTER TABLE `tb_gwc`
